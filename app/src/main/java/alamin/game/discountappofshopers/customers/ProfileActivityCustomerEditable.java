...
public class ProfileActivityCustomerEditable extends AppCompatActivity implements View.OnClickListener {
    ...
    private void save_info_into_database() {
        try {
            ...
            Toast.makeText(ProfileActivityCustomerEditable.this, "Save Successfully!", Toast.LENGTH_SHORT).show();
        } catch (Exception e) {
            Log.d("TAG", "save_info_into_database: " + e);
        }
            ...
            if (pic_uri != null) {
                ...
                ref.putFile(pic_uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        Toast.makeText(ProfileActivityCustomerEditable.this, "Image Uploaded Successfully!", Toast.LENGTH_SHORT).show();
